...
\todo{Is the workflow figure useful?  It does not match the "3 phases"}
\todo{this figure needs to move to near the first place it is referenced (way above)}
