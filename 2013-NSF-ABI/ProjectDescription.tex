...
Lay members of the media have no reliable way to determine the importance or quality of theories upon which they report.  Direct consultation of scientists suffers from by bias and possible lack of available expertise.  However, \textit{SciDash} will provide a less biased way for non-experts to identify model scope and validity, and compare these amongst competing models.  With model and test sources well-documented in commit logs and code headers, contributors may be contacted for comment.  Commentary embedded in GitHub repository issue tracking should also be a helpful media resource.  
